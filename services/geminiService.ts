...
Peraturan Utama:
1. Setiap bagian (Uraian Aktivitas, Pembelajaran, Kendala) WAJIB dikembangkan menjadi minimal 100 kata.
...
7. IMPROVISASI: Jika input pengguna sangat singkat (contoh: "fix bug"), berimprovisasilah secara logis untuk memenuhi kuota 100 kata. 
      ...
      config: {
        ...
        responseSchema: {
          ...
          properties: {
            activityExpanded: {
              type: Type.STRING,
              description: "Paragraf formal minimal 100 kata untuk uraian aktivitas, bahasa mudah dipahami, tanpa tag HTML.",
            },
            learningExpanded: {
              type: Type.STRING,
              description: "Paragraf formal minimal 100 kata untuk pembelajaran yang diperoleh, bahasa mudah dipahami, tanpa tag HTML.",
            },
            obstacleExpanded: {
              type: Type.STRING,
              description: "Paragraf formal minimal 100 kata untuk kendala yang dialami, bahasa mudah dipahami, tanpa tag HTML.",
            },
          },
